...
<html lang="en">
	<head>
		...
		<title>Admin | Action,Sports</title>
				...
				<div class="container">
					...
					<div class="main-navigation pull-right">
						...
						<ul class="menu">
							...
							<li class="menu-item"><a href="movie_reviews.php">Categories</a></li>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
						...
						<h2 class="entry-title">Action | Sports</h2>
						<p>Big fan of action and soprts then check these out.<br>Click on the movie's title to watch.</p>
						...
						<div class="recipes-list">
							...
							$sql="select * from movies where cat='AS' ";
												...
												<article class='recipe'>
													...
													<div class='recipe-detail'>
														...
														<div class='recipe-meta'>
															...
															<a href='update_movies.php?ID=$result[ID] & mname=$result[mname] & dura=$result[dura] & rd=$result[rd] & cat=$result[cat] & des=$result[des] & link=$result[link] & file=$result[file]'>UPDATE</a>&emsp;&emsp;
															<a href='delete_movies.php?ID=$result[ID]'>DELETE</a>&emsp; &emsp;
