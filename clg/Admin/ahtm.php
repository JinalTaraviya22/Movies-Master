...
<html lang="en">
	<head>
		...
		<title>Admin | Horror,Thriller,Mystry</title>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
						...
						<h2 class="entry-title">Horror | Thriller | Mystry</h2>
						<p>Here are some suspensefull movies. Movies that will give you nightmares.<br>Click on the movie's title to watch.</p>
						...
						<?php
							...
							$sql="select * from movies where cat='HTM'";
