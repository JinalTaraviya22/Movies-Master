...
<html lang="en">
	<head>
		...
		<title>Admin | Romance,Comedy,Drama</title>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
						...
						<h2 class="entry-title">Romance | Comedy | Drama</h2>
						<p>Want to chill then these are perfect for you.<br>Click on the movie's title to watch.</p>
						...
						<?php
							...
							$sql="select * from movies where cat='RCD'";
