			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation pull-right">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="about_me.php">About me</a></li>
						...
						<div class="row">
							<div class="col-md-5">
								<figure class="profile-picture">
									<img src="dummy/ghost.png" alt="movies master">
								</figure>
							</div>
							<div class="col-md-6 col-md-offset-1">
								<h2>Hello, <br> I am Movies Master</h2>
								<p>I am here to give you best movie opinions. You can also tell us your thoughts in reviews.☺ </p>
								<ul class="person-detail">
									<li><span class="icon"><img src="images/icon-baby.png"></span>Born: <strong>22.05.2003</strong></li>
									<li><span class="icon"><img src="images/icon-map-marker.png"></span>Office: <strong>Everywhere</strong></li>
									<li><span class="icon"><img src="images/icon-heart.png"></span>Favourites: <strong>Evil Dead</strong></li>
									<li><span class="icon"><img src="images/icon-clock.png"></span>Experience: <strong>Didn't Count</strong></li>
								</ul>
							</div>
						</div>
					</div>
