				...
				<div class="container">
					...
					<div class="main-navigation pull-right">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="movies_reviews.php">Categories</a></li>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
						...
						<p>Add movies here...<br>
						HTM = Horror,Thriller,Mystery  &emsp; &emsp; &emsp; &nbsp; AS = Action,Sports<br>
						RCD = Romance,Comedy,Drama  &emsp; &emsp;	FSA = Fantasy,Sci-fi,Adventure</p></br>
						
						<form method="post" action="movies_reviews.php" enctype="multipart/form-data">
						<div class="contact-form">
							<div class="row">
								<div class="col-md-5">
									<input type="text" placeholder="Movie name..." name="mname" required="">
									<input type="text" placeholder="Duration (hh:mm)" name="dura" required="">
									<input type="text" placeholder="Release Date (dd/mm/yyyy)" name="rd" required="">
									<input type="text" placeholder="HTM / AS / RCD / FSA" name="cat" required="">
									<input type="file" name="file" required="">
								</div>
								<div class="col-md-7">
									<textarea placeholder="Description" name="des" required=""></textarea>		
									<input type="link" placeholder="Add a link here..." name="link" required="">
									<input type="submit" value="Add Movie" name="submit">
										...
										<?php
											...
											if(isset($_POST['submit']))
											{
												...
												$cat=$_POST['cat'];
												$link=$_POST['link'];
												$upload=$loc.basename($_FILES['file']['name']);
												
												if(move_uploaded_file($_FILES['file']['tmp_name'],$upload))
												{

													$sql="insert into movies values('ID','$mname','$dura','$rd','$cat','$des','$link','$upload')";	
